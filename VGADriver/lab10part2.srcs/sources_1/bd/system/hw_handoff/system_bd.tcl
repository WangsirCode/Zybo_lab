...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.c_include_s2mm {0} CONFIG.c_mm2s_genlock_mode {1} CONFIG.c_mm2s_linebuffer_depth {2048} CONFIG.c_mm2s_max_burst_length {16} CONFIG.c_use_mm2s_fsync {1}  ] $axi_vdma_0
